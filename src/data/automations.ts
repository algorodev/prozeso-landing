...
export const AUTOMATIONS = [
  {
    ...
    description:
      "An always-on AI receptionist that answers calls and messages, gives information, and books, modifies or cancels reservations and appointments.",
    icon: Phone,
  ...
  },
  {
    ...
    description:
      "Automatically calls back or messages missed callers so you recover bookings and leads instead of losing them.",
    icon: RotateCw,
  ...
  },
  {
    ...
    description:
      "Automatic reminders via SMS, WhatsApp, email or calls before an appointment, with confirmation and one-click reschedule or cancel.",
    icon: Calendar,
  ...
  },
  {
    ...
    description:
      "Pre-visit workflow to collect data, forms and preferences and send tailored instructions before the client arrives.",
    icon: ClipboardList,
  ...
  },
  {
    ...
    description:
      "When a client doesn’t show up, automatically follows up to reschedule, charge a fee or deposit when applicable, and log the event.",
    icon: PieChart,
  ...
  },
  {
    ...
    description:
      "Uses cancellations or empty slots to automatically reach out to a waitlist or recent customers and fill those gaps.",
    icon: Zap,
  ...
  },
  {
    ...
    description:
      "If someone starts but doesn’t finish a booking or request, this workflow reaches out to help them complete it.",
    icon: MessageSquare,
  ...
  },
  {
    ...
    description:
      "Brings back inactive customers and triggers periodic recalls based on time since last visit or treatment schedule.",
    icon: RotateCw,
  ...
  },
  {
    ...
    description:
      "After a positive experience, asks for a review and routes happy clients to Google/portals while handling negative feedback privately.",
    icon: Star,
  ...
  },
  {
    ...
    description:
      "Automates sending payment links, capturing deposits, and delivering invoices, integrated with your billing system.",
    icon: ClipboardList,
  ...
  },
  {
    ...
    description:
      "A virtual concierge for guests currently staying at the property: answers questions, handles requests and proposes upsells.",
    icon: Gift,
  ...
  },
  {
    ...
    description:
      "Specialised workflow for handling group and event requests (weddings, conferences, corporate stays), qualifying and structuring them for sales.",
    icon: Users,
  ...
  },
  {
    ...
    description:
      "Handles leads from property portals, qualifies them and routes them to the right agent/property with booked viewings when possible.",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      "After a property viewing, follows up to gather feedback, check interest level, and collect offers or applications.",
    icon: MessageSquare,
    category: ["lead-management", "feedback", "post-viewing"],
    verticals: ["Real Estate"],
    metrics: [
      "28% more offers collected",
      "< 24h feedback turnaround",
      "Nurtures warm interest",
    ],
  },
  {
    ...
    description:
      "Orchestrates the journey from “accepted tenant” to “moved in”: documents, contract, payments and key handover instructions.",
    icon: ClipboardList,
...
export const AUTOMATIONS_DETAILS = [
  {
    ...
    examples: [
      ...
      },
      {
        ...
        result:
          "Table filled. Customer satisfaction high. Restaurant never stops answering phones.",
      },
      {
        ...
        result:
          "Deal moves forward immediately. No delay. No lost lead. +50% faster conversion.",
      },
      {
    ...
    metrics: [
      { stat: "45", suffix: "%", description: "Bookings from captured calls" },
      {
        stat: "24",
        suffix: "/7",
        description: "Always available, never tired",
      },
    ...
    features: [
      {
        ...
        description:
          "Sounds like a real person. Understands context, asks follow-ups, never feels robotic.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Asks the right questions to qualify leads. Transfers hot prospects to your team immediately.",
      },
      {
        title: "FAQ Knowledge Base",
        description:
          "Answers common questions about hours, pricing, services, policies without human intervention.",
      },
      {
        title: "After-Hours Handling",
        description:
          "Can take emergency calls, store messages, or route to on-call staff based on urgency.",
      },
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    description:
      "Automatically recover missed calls with instant callbacks and smart messaging.",
    ...
    examples: [
      ...
      },
      {
        ...
        scenario:
          "Hair salon misses a call during color service; auto‑text offers to rebook with preferred stylist.",
        result: "Appointment saved within 2 minutes.",
      },
      {
        title: "Restaurant Callback",
        scenario:
          "Dinner rush missed call; system calls back and books a table for 4 at 21:30.",
        result: "Covers a cancellation and keeps the table filled.",
      },
      {
        title: "Hotel Inquiry Recovery",
        scenario:
          "Front desk misses international call; WhatsApp auto‑reply answers and secures a two‑night stay.",
        result: "Direct booking captured without OTA fees.",
      },
      {
        title: "Real Estate Lead Recovery",
        scenario:
          "Agent misses a new buyer call; workflow texts, qualifies budget/timing, and books a viewing.",
    ...
    metrics: [
      ...
      { stat: "60", suffix: "s", description: "Typical follow-up time" },
      {
        stat: "18",
        suffix: "%",
        description: "Conversion boost post follow-up",
      },
    ],
    features: [
      {
        title: "Instant Trigger",
        description: "Detects missed calls and reacts immediately.",
      },
      {
        title: "Smart Channel",
        description:
          "Decides whether to call or message based on context and preferences.",
      },
      {
        title: "Auto-Booking",
        description:
          "Books, reschedules, or cancels directly in your calendar.",
      },
    ],
    faqs: [
      {
        question: "Can it avoid duplicate callbacks?",
        answer: "Yes, it deduplicates and rate-limits per caller.",
      },
      {
        question: "What if voicemail exists?",
        answer: "It can parse voicemails and respond accordingly.",
      },
    ],
  },
  {
    ...
    description:
      "Automated multi-channel reminders with confirmations and easy rescheduling.",
    ...
    examples: [
      {
        ...
        scenario: "SMS 24h and 3h before appointment with 1‑tap confirm.",
        result: "32% fewer no‑shows.",
      },
      {
        title: "Restaurant Reminder",
        scenario: "WhatsApp reminder 6h before dinner with modify/cancel link.",
        result: "Fewer empty tables, smoother turns.",
      },
      {
        title: "Clinic Reminder",
        scenario: "SMS 48h + 24h with pre‑visit instructions.",
        result: "Lower no‑shows and prepared patients.",
      },
      {
        title: "Hotel Spa Reminder",
        scenario: "In‑stay spa booking reminder 2h prior with add‑to‑calendar.",
        result: "Higher utilization of spa therapists.",
      },
      {
        title: "Viewing Reminder",
        scenario:
          "Email + SMS reminder for property viewing with map and parking tips.",
        result: "Fewer last‑minute cancellations.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        title: "Smart Timing",
        description: "Schedules reminders at optimal times.",
      },
      {
        title: "2‑Way",
        description:
          "Understands replies and updates the booking automatically.",
      },
      {
        title: "Reschedule Links",
        description: "1‑tap reschedule/cancel with policy enforcement.",
      },
    ],
    faqs: [
      {
        question: "Can I set multiple reminders?",
        answer: "Yes, fully configurable sequences per service.",
      },
    ],
  },
  {
    ...
    description:
      "Collect forms, preferences, and consents pre‑visit and share tailored instructions.",
    ...
    examples: [
      {
        title: "Clinic Intake",
        scenario: "Medical intake and consent collected 24h prior.",
        result: "-25% front‑desk time.",
      },
      {
        title: "Salon Pre‑Consult",
        scenario:
          "Form captures hair history and inspiration photos before visit.",
        result: "Stylist arrives prepared; better outcomes.",
      },
      {
        title: "Restaurant Pre‑Order",
        scenario: "Group pre‑selects menu and dietary notes day before.",
        result: "Service speeds up; fewer errors.",
      },
      {
        title: "Hotel Pre‑Arrival",
        scenario:
          "Guest uploads ID, selects arrival time, and room preferences.",
        result: "Faster check‑in; personalized welcome.",
      },
      {
        title: "Buyer Pre‑Viewing",
        scenario: "Collects proof‑of‑funds and preferences before tours.",
        result: "Agents tailor the route; higher fit.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        ...
        description: "Show the right questions per service/guest.",
      },
      {
      ...
      },
      {
        ...
        description: "Auto‑generate what to bring/wear/expect.",
      },
    ],
    faqs: [
      {
        question: "HIPAA/GDPR?",
        answer: "Compliant processing with audit trails and access controls.",
      },
    ],
  },
  {
    ...
    description:
      "Recover revenue from no‑shows with smart follow‑ups, rescheduling, and policy‑based fees.",
    ...
    examples: [
      {
        title: "Spa Policy",
        scenario: "No‑show triggers fee and rebooking options.",
        result: "-18% revenue leakage.",
      },
      {
        title: "Restaurant Policy",
        scenario:
          "No‑show dinner triggers deposit charge per policy and rebook link.",
        result: "Seats refilled; policy applied fairly.",
      },
      {
        title: "Clinic Policy",
        scenario:
          "Missed appointment asks reason, offers reschedule, applies fee when applicable.",
        result: "Fewer repeats; recovered revenue.",
      },
      {
        title: "Hotel Amenity No‑Show",
        scenario: "Spa/golf no‑show applies fee and offers new time.",
        result: "Amenity revenue protected.",
      },
      {
        title: "Property Viewing No‑Show",
        scenario:
          "Buyer misses viewing; assistant offers alternate slots and reconfirms seriousness.",
        result: "Keeps pipeline moving.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        title: "Policy Engine",
        description: "Percent/flat fees with grace rules.",
      },
      {
        title: "Empathetic Copy",
        description: "Tone controls and reason capture.",
      },
    ...
    faqs: [
      {
        ...
        answer: "Evidence logs and policy acknowledgement reduce disputes.",
      },
    ],
  },
  {
    ...
    description:
      "Automatically fill last‑minute cancellations by reaching out to waitlists and recent customers.",
    ...
    examples: [
      {
        title: "Dentist Gaps",
        scenario: "Morning cancellation triggers offers to top 10 waitlist.",
        result: "Chair time protected.",
      },
      {
        title: "Salon Cancellation",
        scenario: "Stylist cancellation fills with VIP list first.",
        result: "Day stays fully booked.",
      },
      {
        title: "Restaurant Table Fill",
        scenario: "Late cancellation sends offers to diners within 2km.",
        result: "Table re‑sold in minutes.",
      },
      {
        title: "Hotel Spa Slot",
        scenario:
          "Vacated massage spot offered to in‑house guests via WhatsApp.",
        result: "Occupancy of spa hours up.",
      },
      {
        title: "Open House Slot",
        scenario: "Viewing slot opens; auto‑offers to interested buyers.",
        result: "Schedule remains tight and efficient.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        ...
        description: "Recent inquiries and VIPs first.",
      },
      {
        title: "Instant Confirm",
        description: "1‑tap accept with deposit if needed.",
      },
      {
        title: "Fairness Controls",
        description: "Throttle offers to avoid spam.",
      },
    ],
    faqs: [
      {
        question: "How is priority set?",
        answer: "You can configure rules by recency, value, or membership.",
      },
    ],
  },
  {
    ...
    description:
      "Recover started‑but‑unfinished bookings with timely nudges and assistance.",
    ...
    examples: [
      {
        title: "Table Booking",
        scenario:
          "Cart abandoned at payment; WhatsApp link completes in 2 taps.",
        result: "+1 table booked.",
      },
      {
        title: "Salon Abandon",
        scenario:
          "Haircut booking dropped at date step; SMS deep‑link resumes.",
        result: "Friction removed; booking completed.",
      },
      {
        title: "Clinic Abandon",
        scenario:
          "Patient drops at insurance entry; assistant clarifies accepted plans.",
        result: "Patient completes booking confidently.",
      },
      {
        title: "Hotel Abandon",
        scenario:
          "Guest leaves checkout; email with saved quote and perks brings them back.",
        result: "Direct booking recovered.",
      },
      {
        title: "Viewing Abandon",
        scenario:
          "Buyer stops at time selection; assistant proposes 3 options.",
        result: "Viewing scheduled within the hour.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        ...
        description: "Understands where they dropped and why.",
      },
      {
        title: "One‑Click Resume",
        description: "Deep links to the exact step.",
      },
      {
        title: "Assistant Option",
        description: "Chat or voice help to finish.",
      },
    ],
    faqs: [
      {
        question: "Privacy?",
        answer: "GDPR‑compliant with explicit consent and opt‑out controls.",
      },
    ],
  },
  {
    ...
    description:
      "Bring back inactive customers and schedule periodic recalls automatically.",
    ...
    outcomes: ["16% reactivation rate", "+9% LTV", "Steady base utilization"],
    ...
    examples: [
      {
        ...
        scenario: "6‑month dental recall triggered automatically.",
        result: "Calendar filled in advance.",
      },
      {
        title: "Salon Reactivation",
        scenario:
          "Clients who haven’t visited in 12 weeks get a personalized style refresh offer.",
        result: "Dormant clients return.",
      },
      {
        title: "Restaurant Reactivation",
        scenario: "Guests from last season receive a chef’s tasting invite.",
        result: "Off‑peak nights fill up.",
      },
      {
        title: "Hotel Reactivation",
        scenario: "Past guests get a mid‑week upgrade offer.",
        result: "Shoulder nights improved.",
      },
      {
        title: "Buyer Recall",
        scenario: "Cold buyers pinged with new matching listings.",
        result: "Pipeline re‑engagement.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        title: "Cadence Rules",
        description: "Per service recall intervals and reminders.",
      },
      {
        title: "Offer Management",
        description: "Optional incentives to return.",
      },
      {
        title: "Opt‑down",
        description: "Lower‑frequency option instead of unsubscribe.",
      },
    ],
    faqs: [
      {
        question: "Spam risk?",
        answer: "Built‑in frequency caps and preference centers.",
      },
    ],
  },
  {
    name: "Review Booster",
    description:
      "Increase reviews by asking at the right moment and routing happy clients to public sites.",
    ...
    examples: [
      {
        title: "Post‑Dinner Ask",
        scenario: "CSAT > 4 triggers Google prompt.",
        result: "Reviews triple in 60 days.",
      },
      {
        title: "Salon Review Ask",
        scenario: "Satisfied client receives a review link 2h after visit.",
        result: "+0.4★ average within 8 weeks.",
      },
      {
        title: "Clinic Review Ask",
        scenario: "Positive NPS triggers healthcare‑appropriate portal link.",
        result: "More credible public feedback.",
      },
      {
        title: "Hotel Review Ask",
        scenario: "Checkout survey routes happy guests to Google/TripAdvisor.",
        result: "Ranking improves and visibility grows.",
      },
      {
        title: "Viewing Feedback",
        scenario:
          "After viewing, buyer rates experience privately; happy buyers get a public review prompt for the agency.",
        result: "Higher agency reputation.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        ...
        description: "Asks only when experience is positive.",
      },
      {
        title: "Portal Routing",
        description: "Send to Google/TripAdvisor/industry portals.",
      },
      {
        title: "Response Templates",
        description: "Handle negatives privately with empathy.",
      },
    ],
    faqs: [
      {
        question: "Against platform rules?",
        answer: "We never gate; we ask and route ethically.",
      },
    ],
  },
  {
    ...
    description:
      "Automate payment links, deposits, and invoice delivery integrated with your billing.",
    headline: "Get Paid Faster",
    subheading:
      "Reduce overdue invoices and friction with secure links and reminders.",
    slug: "billing-and-invoice",
    problem: "Chasing payments wastes time and hurts cash flow.",
    solution:
    ...
    examples: [
      {
        ...
        scenario: "Collect deposit at booking via link.",
        result: "No‑show risk reduced.",
      },
      {
        title: "Salon Invoice",
        scenario: "Color correction requires deposit link sent at booking.",
        result: "Commitment secured; cancellations drop.",
      },
      {
        title: "Restaurant Group Bill",
        scenario: "Pre‑event invoice with partial payments for a group menu.",
        result: "Cash flow improved before service.",
      },
      {
        title: "Clinic Co‑Pay",
        scenario: "Automated co‑pay link sent morning of appointment.",
        result: "Faster check‑out; less AR aging.",
      },
      {
        title: "Hotel Pre‑Auth",
        scenario: "Pre‑arrival payment link collects deposit and T&Cs.",
        result: "Fewer disputes; smoother check‑in.",
      },
      {
        title: "Reservation Deposit (Real Estate)",
        scenario: "Holding deposit link for rental application.",
        result: "Serious applicants prioritized.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        ...
        description: "Syncs with accounting systems.",
      },
      {
        title: "Partial Payments",
        description: "Deposits and installment options.",
      },
    ...
    faqs: [
      {
        question: "Fees?",
        answer: "Pass‑through or absorb; fully configurable.",
      },
    ],
  },
  {
    ...
    description:
      "Virtual concierge for staying guests: requests, Q&A, and personalized upsells.",
    headline: "Delight Every Guest",
    subheading:
      "Answer instantly and grow ancillary revenue with timely offers.",
    slug: "in-stay-concierge-upsell",
    problem: "Front desk is overloaded, and guests wait for simple requests.",
    solution:
    ...
    examples: [
      {
        ...
        scenario: "Guest asks at 1am; assistant confirms with fee.",
        result: "Revenue per stay up.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        ...
        description: "Sends tasks to housekeeping/maintenance.",
      },
      {
        title: "Menu of Upsells",
        description: "Spa, dining, room upgrades at the right time.",
      },
      {
        title: "Multi‑language",
        description: "Serve international guests naturally.",
      },
    ],
    faqs: [
      {
        question: "PMS support?",
        answer: "We integrate with major PMS vendors and via iCal.",
      },
    ],
  },
  {
    ...
    description:
      "Qualify and structure group/event requests and hand them to sales with everything needed.",
    ...
    problem: "Large inquiries get stuck in inboxes and lose momentum.",
    solution:
    ...
    examples: [
      {
        ...
        scenario: "Collects guest count, spend, date; schedules tasting.",
        result: "Sales works only qualified leads.",
      },
      {
        title: "Restaurant Group Booking",
        scenario:
          "Corporate dinner inquiry captured via form; assistant confirms menu options and books a site visit.",
    ...
    features: [
      {
        ...
        description: "Blocks pencil holds when approved.",
      },
      {
        title: "Proposal Kit",
        description: "Auto‑drafts a first proposal template.",
      },
    ...
    faqs: [
      {
        ...
        answer: "Add venue‑specific requirements and attachments.",
      },
    ],
  },
  {
    ...
    description:
      "Qualify property portal leads, answer FAQs, and auto‑book viewings, routing to the best agent.",
    ...
    examples: [
      {
        title: "Portal Ping",
        scenario:
          "Lead comes from Idealista; assistant qualifies and books Saturday 11:00.",
        result: "Agent meets hot, informed buyer.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        title: "Qualification Tree",
        description: "Budget, area, financing, timeframe.",
      },
      {
        title: "Agent Matching",
        description: "Routes by territory and workload.",
      },
      {
        title: "Auto‑Scheduling",
        description: "Books the first available slot that works for all.",
      },
    ],
    faqs: [
      {
        question: "Multiple listings?",
        answer: "It can bundle options and suggest similar properties.",
      },
    ],
  },
  {
    ...
    description:
      "After viewings, gather feedback, score interest, and collect offers or next steps.",
    ...
    problem: "Manual follow‑ups are inconsistent and forgettable.",
    solution:
    ...
    examples: [
      {
        ...
        scenario: "Asks 5 key questions and invites an offer.",
        result: "Pipeline clarity up.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        title: "Scorecards",
        description: "Rates seriousness and fit automatically.",
      },
      {
        title: "Offer Intake",
        description: "Structured forms with proof of funds uploads.",
      },
      {
        title: "Agent Alerts",
        description: "Hot interest pinged immediately.",
      },
    ],
    faqs: [
      {
        question: "Multiple viewers?",
        answer: "Sends personalized follow‑ups to each attendee.",
      },
    ],
  },
  {
    ...
    description:
      "From accepted tenant to moved‑in: documents, contracts, payments, and handover.",
    ...
    tools: ["DocuSign", "Payments", "File Upload", "Calendar"],
    verticals: [{ name: "Real Estate", slug: "real-estate" }],
    examples: [
      {
        title: "Lease Package",
        scenario: "Automates contract, deposit, utilities setup.",
        result: "Keys handed over on time.",
      },
    ],
    metrics: [
    ...
    features: [
      {
        title: "Checklist",
        description: "Visual progress for tenant and manager.",
      },
      {
        title: "E‑Sign",
        description: "Legally binding signatures and storage.",
      },
      {
        title: "Payment Links",
        description: "Collect deposits and first rent.",
      },
    ],
    faqs: [
      {
        question: "Country differences?",
        answer: "Templates adapt to local requirements.",
      },
    ],
  },
];
