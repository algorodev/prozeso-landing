...
export default function AutomationHeroBackground() {
  ...
  const shapes = useMemo<ShapeConfig[]>(
    () => [
      { id: 'a1', type: 'circle', size: 220, top: '8%', left: '64%', opacity: 0.32, blurClass: 'blur-3xl', depth: 1 },
      { id: 'a2', type: 'hex', size: 160, top: '20%', left: '78%', opacity: 0.28, blurClass: 'blur-2xl', depth: 1, rotation: 8 },
      { id: 'a3', type: 'diamond', size: 180, top: '56%', left: '72%', opacity: 0.24, blurClass: 'blur-2xl', depth: 1 },
      { id: 'a4', type: 'square', size: 120, top: '12%', left: '52%', opacity: 0.48, blurClass: 'blur-xl', depth: 2, rotation: 12 },
      { id: 'a5', type: 'triangle', size: 140, top: '34%', left: '86%', opacity: 0.38, blurClass: 'blur-xl', depth: 2 },
      { id: 'a6', type: 'hex', size: 130, top: '72%', left: '84%', opacity: 0.34, blurClass: 'blur-lg', depth: 2 },
      { id: 'a7', type: 'circle', size: 120, top: '26%', left: '60%', opacity: 0.62, blurClass: 'blur-md', depth: 3 },
      { id: 'a8', type: 'diamond', size: 110, top: '48%', left: '92%', opacity: 0.52, blurClass: 'blur-md', depth: 3, rotation: -10 },
      { id: 'a9', type: 'square', size: 100, top: '80%', left: '66%', opacity: 0.5, blurClass: 'blur-sm', depth: 3 },
      { id: 'a10', type: 'triangle', size: 105, top: '62%', left: '56%', opacity: 0.46, blurClass: 'blur-sm', depth: 3 },
    ],
    [],
  )
  ...
  useEffect(() => {
    ...
    els.forEach((el, idx) => {
      ...
      animate(el, { translateX: [-ampX, ampX], duration: dX, easing: 'linear', loop: true, direction: 'alternate', delay })
      animate(el, { translateY: [ampY, -ampY], duration: dY, easing: 'linear', loop: true, direction: 'alternate', delay: delay + 180 })
      animate(el, { rotate: [-8, 8], duration: dR, easing: 'easeInOutSine', loop: true, direction: 'alternate', delay: delay + 320 })
      animate(el, { scale: [1, depth === 1 ? 1.03 : depth === 2 ? 1.035 : 1.04], duration: dR + 1200, easing: 'easeInOutSine', loop: true, direction: 'alternate' })
    })
    ...
    const geoWraps = Array.from(root.querySelectorAll<HTMLElement>('[data-geo-wrap]'))
    ...
    const applyParallax = () => {
      ...
      geoWraps.forEach((el) => {
        ...
        animate(el, { translateX: tx, translateY: ty, duration: 240, easing: 'easeOutQuad' })
      })
      if (waveWrap) {
        // Smaller movement for the whole wave cluster
        const tx = mx * 8
        const ty = my * 5
        animate(waveWrap, { translateX: tx, translateY: ty, duration: 280, easing: 'easeOutQuad' })
      }
    }
  ...
  return (
    <div ref={containerRef} className='pointer-events-none absolute inset-0 -z-10 overflow-hidden'>
      ...
      >
        <svg aria-hidden className='h-full w-full rotate-[8deg]' viewBox='0 0 800 1200' fill='none'>
          <defs>
          ...
          <g data-wave>
            <path d='M-50 200 C 100 120, 220 260, 380 200 S 650 140, 820 220' stroke='url(#ahg1)' strokeWidth='18' opacity='0.6' />
          </g>
          <g data-wave>
            <path d='M-80 360 C 80 300, 240 420, 380 360 S 650 300, 840 360' stroke='url(#ahg2)' strokeWidth='14' opacity='0.55' />
          </g>
          <g data-wave>
            <path d='M-60 520 C 120 460, 260 600, 420 540 S 680 480, 860 560' stroke='url(#ahg1)' strokeWidth='10' opacity='0.5' />
          </g>
        </svg>
      </div>
