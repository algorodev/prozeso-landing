...
const Impact = () => {
  ...
  const items = [
    { icon: TrendingUp, title: t("items.reservations.title"), body: t("items.reservations.body") },
    { icon: TimerReset, title: t("items.hours.title"), body: t("items.hours.body") },
    { icon: Headphones, title: t("items.support.title"), body: t("items.support.body") },
    { icon: PiggyBank, title: t("items.costs.title"), body: t("items.costs.body") },
  ];
