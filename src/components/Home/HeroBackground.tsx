...
export default function HeroBackground() {
	...
	const shapes = useMemo<ShapeConfig[]>(
		() => [
			{ id: "s1", type: "circle", size: 220, top: "8%", left: "62%", opacity: 0.35, blurClass: "blur-3xl", depth: 1 },
			{ id: "s2", type: "hex", size: 180, top: "18%", left: "78%", opacity: 0.28, blurClass: "blur-2xl", depth: 1, rotation: 8 },
			{ id: "s3", type: "diamond", size: 160, top: "58%", left: "70%", opacity: 0.25, blurClass: "blur-2xl", depth: 1 },
			{ id: "s4", type: "square", size: 140, top: "10%", left: "50%", opacity: 0.45, blurClass: "blur-xl", depth: 2, rotation: 12 },
			{ id: "s5", type: "triangle", size: 150, top: "35%", left: "85%", opacity: 0.4, blurClass: "blur-xl", depth: 2 },
			{ id: "s6", type: "hex", size: 120, top: "70%", left: "82%", opacity: 0.38, blurClass: "blur-lg", depth: 2 },
			{ id: "s7", type: "circle", size: 110, top: "28%", left: "60%", opacity: 0.65, blurClass: "blur-md", depth: 3 },
			{ id: "s8", type: "diamond", size: 100, top: "48%", left: "90%", opacity: 0.6, blurClass: "blur-md", depth: 3, rotation: -10 },
			{ id: "s9", type: "square", size: 90, top: "78%", left: "65%", opacity: 0.55, blurClass: "blur-sm", depth: 3 },
			{ id: "s10", type: "triangle", size: 95, top: "62%", left: "55%", opacity: 0.5, blurClass: "blur-sm", depth: 3 },
			{ id: "s11", type: "hex", size: 105, top: "22%", left: "92%", opacity: 0.5, blurClass: "blur-sm", depth: 3 },
			{ id: "s12", type: "circle", size: 80, top: "52%", left: "58%", opacity: 0.55, blurClass: "blur-sm", depth: 3 },
		],
		[]
	);
	...
	useEffect(() => {
		...
		els.forEach((el) => {
			...
			const drift =
				depth === 1 ? 18 : depth === 2 ? 12 : 8;
			const rotate =
				depth === 1 ? 6 : depth === 2 ? 10 : 14;
			const duration =
				depth === 1 ? 9000 : depth === 2 ? 7000 : 5200;
