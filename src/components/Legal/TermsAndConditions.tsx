    ...
    >
      <section id="agreement">
        ...
        <p>
          ...
          and Prozeso regarding your access to and use of this website and any
          related services. By accessing the site, you agree that you have read,
      ...
      <section id="intellectual-property" className="py-8">
        ...
        <p>
          ...
          photographs, and graphics on the Site are owned or controlled by us
      ...
      <section id="prohibited-activities" className="py-8">
        ...
        <ul>
          <li>
            Systematically retrieve data or content to create a collection or
            database.
          </li>
      ...
      <section id="governing-law" className="py-8">
        ...
        <p>
          ...
          of the jurisdiction where Prozeso is established, without regard to
