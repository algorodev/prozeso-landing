    ...
    <LegalContainer title="Privacy Policy" updatedAt="Nov 3, 2025" toc={toc}>
      ...
      <section id="data-we-collect" className="py-8">
        ...
        <ul>
          ...
          <li>
            Usage information such as pages visited, features used, and actions
            taken.
          </li>
          <li>
      ...
      <section id="how-we-use-data">
        ...
        <ul>
          ...
          <li>
            To communicate with you, including marketing and transactional
            messages.
          </li>
      ...
      <section id="sharing" className="py-8">
        ...
        <p>
          ...
          with service providers who perform services on our behalf, in
          accordance with contracts that protect your data.
        </p>
      </section>
