                    ...
                    {problem.items.map((item, i) => (
                      ...
                      >
                        ...
                        <span className="text-sm leading-relaxed">
                          {id &&
                          t.has(`verticals.${id}.problems.${idx}.items.${i}`)
                            ? (t(
                                `verticals.${id}.problems.${idx}.items.${i}`,
                              ) as string)
                            : item}
                        </span>
                      </li>
                ...
                <div key={idx} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      {id &&
                      t.has(`verticals.${id}.solution.${idx}.description`)
                        ? (t(
                            `verticals.${id}.solution.${idx}.description`,
                          ) as string)
                        : item.description}
                    </p>
                  </div>
